      ...
      <div className="md:pl-64">
        ...
        <main className="pt-6 px-4 md:px-8 pb-12">
          ...
          <div className="bg-[#091e36] rounded-xl p-4 sm:p-6 lg:p-10">
              ...
              <div className="border border-white/30 rounded-lg p-6 w-full max-w-[483px] h-[500px] flex flex-col justify-between">
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-white text-sm font-bold mb-6 leading-relaxed">
                    <span className="text-white/70">Option:</span> 4.9L | from 2/3/91 (AIR inner manifold) | E4OD transmission
                  </p>

                  {/* Engine Image with white shadow */}
                  <div className="relative w-full max-w-[360px] h-[300px] mb-6 mx-auto before:absolute before:inset-0 before:rounded-xl
                ...
                <div className="flex justify-between items-center text-white">
                  <div>
                    ...
                    <span className="mb-8 line-through text-white/50 font-bold text-lg">100$</span>
                  </div>
                  <div className="text-lg mb-4 font-bold">2 parts in stock</div>
                </div>
              </div>
              ...
              <div className="rounded-lg p-6 flex-1 min-h-[500px] flex flex-col justify-between shadow-lg shadow-white/10">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                      <label className="block mb-1 text-white text-[16px] font-semibold">Product Name</label>
                      <input
                    ...
                    <div>
                      <label className="block mb-1 text-white text-[16px] font-semibold">Model</label>
                      <input
                        className="w-full bg-[#091e36] border border-white/20 rounded px-3 py-2 text-white font-semibold cursor-text"
                  ...
                  {/* Description Table */}
                  <h4 className="text-white text-base font-semibold mb-3">Description</h4>
                  <div className="text-[16px]">
                    {[
                      ...
                      <div
                        key={idx}
                        className={`flex justify-between py-3 px-4 ${idx % 2 === 0 ? 'bg-[#0F2D5A]' : 'bg-[#000000]'}`}
                      >
                        <span className="w-1/2 text-white font-bold">{label}</span>
                        <span className="w-1/2 text-right text-white font-bold">{value}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            {/* Warranty Section */}
            <div className="mt-10">
              <h4 className="text-white md:text-2xl text-xl font-semibold mb-3">Warranty</h4>
              <p className="text-[#E8F3FF] md:text-xl text-sm font-normal leading-relaxed mb-6">
                You may return any item in its original condition for a full refund within 30 days of
                receipt of your shipment, less shipping charges. It typically takes us approximately
                3–5 business days to process a credit back to your account and 2–3 business days for
