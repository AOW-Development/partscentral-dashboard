        ...
        <table className="w-full text-sm text-white table-auto">
          <thead>
            <tr className="border-b border-white/10 text-left">
              <th className="py-3 px-1 font-medium">Product</th>
              <th className="py-3 px-1 font-medium">Review</th>
              <th className="py-3 px-1 font-medium">Sold</th>
              <th className="py-3 px-1 font-medium">Price</th>
            </tr>
          </thead>
          <tbody>
            {topProducts.map((product, index) => (
              <tr
                key={index}
                className="border-b border-white/10 hover:bg-white/5 hover:rounded transition cursor-pointer"
              >
