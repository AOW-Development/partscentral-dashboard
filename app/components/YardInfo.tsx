...
const YardInfo: React.FC<YardInfoProps> = ({
  ...
  useEffect(() => {
    if (submitReason && reason.trim() && yardChargeForHistory.trim()) {
  ...
  }, [submitReason, reason, orderId, onYardMoved, yardChargeForHistory]);
    ...
    <div className="relative p-2 mt-6">
      {statusPopUp && (
        <MoveYardPopUp
          ...
          setReason={setReason}
          setYardCharge={setYardChargeForHistory}
